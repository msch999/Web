...
//
var canvas = document.querySelector('#canvas_canvas'),
...
function Factory() {
    ...
    this.rgba = 'rgba(' + randomRange(10, 255) + ', ' +
                          randomRange(10, 255) + ', ' +
                          randomRange(10, 255) + ', ' +
                          randomRange(1.0, 1.0) + ')';
    // this.vx = Math.round(Math.random() * 3);
    // this.vy = Math.round(Math.random() * 3);
    this.vx = Math.round(1 * 2);
    this.vy = Math.round(1 * 2);
    this.factor = randomRange(3, 4);
}
