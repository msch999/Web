import {FLOOR, GOAL, PLAYER, PLAYER_GOAL, WALL} from "./tiles.js";
//import seedrandom from "seedrandom";
import {DIRECTIONS, moveToDirection, oppositeDirection} from "./direction.js";
import Matrix from "./matrix.js";
import {emptyMatrix} from "./util.js";
import {TEMPLATE_SIZE, Templates} from "./template.js";
...
export default class Grid {
  constructor(width = 0,
    ...
    this._rand = new Math.seedrandom(seed);
    this._seed = seed;
