// https://www.youtube.com/watch?v=thVl4UOQSEM&list=PLnTPVrg9-a1NlwQFSfYn78Q-_kk67Q6Tv&index=17
// https://github.com/tamani-coding/threejs-texture-maps.git
...
const textureLoader = new THREE.TextureLoader().setPath('public/');
...
plane6.geometry.attributes.uv2 = plane6.geometry.attributes.uv;
plane6.position.y = 3;
plane6.position.x = 3
plane6.add(cubeCamera)
scene.add(plane6)
